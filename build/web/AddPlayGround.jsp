...
<div id="wrapper">
   ...
   <h2><b>Add Club Details Here</b></h2>
	...
	if(res != null){
		out.println("<center><font face=verdana color=red>"+res+"</center></font>");
			...
			<tr><td><b>Club Name</b></td><td><input type="text" name="gname" required=""/></td></tr>

			<tr><td><b>Club Address</b></td><td><input type="text" name="groundaddress" required=""/></td></tr>
         
		  
                       <tr><td><b>Club Area</b></td><td><input type="text" name="groundarea" required=""/></td></tr>
                        <tr><td><b>Used For</b></td><td><input type="text" name="usedfor" required=""/></td></tr>
                         
                      
			<tr><td></td><td><input type="submit" value="Add Club"/></td>
			</table>
        </form>
        </div>
        </div>
